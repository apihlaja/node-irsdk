...
describe('JsIrSdk', function () {
  ...
  describe('.camControls', function () {
    ...
    describe('.switchCamToCar(carNum, [camGroupNum], [camNum])', function () {
      it('sends switch cmd', function () {
        var mock = Object.create(IrSdkWrapper)
        var sendCmd = sinon.spy(mock, 'sendCmd')
        var iracing = new JsIrSdk(mock)
        iracing.camControls.switchCamToCar(12)
      ...
      it('sends focus at cmd', function () {
        ...
        var sendCmd = sinon.spy(mock, 'sendCmd')
        var iracing = new JsIrSdk(mock)
        iracing.camControls.switchCamToCar(-2)
      ...
      it('switches cam group and cam', function () {
        ...
        var sendCmd = sinon.spy(mock, 'sendCmd')
        var iracing = new JsIrSdk(mock)
        iracing.camControls.switchCamToCar(12, 2, 3)
        sendCmd.should.have.been.calledWithExactly(1, 12, 2, 3)
        iracing._stop()
      })
    })
    describe('.switchCamToPos(carNum, [camGroupNum], [camNum])', function () {
      it('sends switch cmd', function () {
        var mock = Object.create(IrSdkWrapper)
        var sendCmd = sinon.spy(mock, 'sendCmd')
        var iracing = new JsIrSdk(mock)
        iracing.camControls.switchCamToPos(12)
      ...
      it('sends focus at cmd', function () {
        ...
        var sendCmd = sinon.spy(mock, 'sendCmd')
        var iracing = new JsIrSdk(mock)
        iracing.camControls.switchCamToPos(-2)
      ...
      it('switches cam group and cam', function () {
        ...
        var sendCmd = sinon.spy(mock, 'sendCmd')
        var iracing = new JsIrSdk(mock)
        iracing.camControls.switchCamToPos(12, 2, 3)
  ...
  describe('.playbackControls', function () {
    ...
    describe('.goToFrame(frameNum, rpyPosMode)', function () {
      it('sends cmd with args', function () {
        var mock = Object.create(IrSdkWrapper)
        var sendCmd = sinon.spy(mock, 'sendCmd')
        var iracing = new JsIrSdk(mock)
        iracing.playbackControls.goToFrame(5, 1)
      ...
      it('rpyPosMode can be given as string', function () {
        ...
        var sendCmd = sinon.spy(mock, 'sendCmd')
        var iracing = new JsIrSdk(mock)
        iracing.playbackControls.goToFrame(17, 'end')
